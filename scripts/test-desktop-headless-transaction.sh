...
# System Manager's disposable container. The real DGX must remain exact
# retained generation five/headless before and after. This program never roots,
# registers, activates, isolates, or reboots the live host.
